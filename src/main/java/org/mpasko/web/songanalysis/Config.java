...
public class Config {
    ...
    public List<String> english_songs = Arrays.asList("unhappy refrain", "scarlett story", "the beast",
            "go to west", "silver sky", "complicated", "guilty crown bios", "layers mod", "owari no seraph",
